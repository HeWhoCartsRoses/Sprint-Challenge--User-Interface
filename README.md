...
semantic html is code that is easily legible and follow along with.
2. Name two big differences between ```display: block;``` and ```display: inline;```.
display inline does not break the text and can be put in a paragraph, and block can have a witdh and height.
3. What are the 4 areas of the box model?
margin, border, padding, and content.
4. While using flexbox, what axis does the following property work on: ```align-items: center```?
the X axis.
5. Explain why git is valuable to a team of developers.
you can all see what the others have worked on, work on different portions, and have a shared hub for content with version control
